...
export default function SignUp() {
  ...
  useEffect(() => {
    getHomepageSettings().then(setHomepageSettings).catch(console.error);
  ...
  const { percent: strengthPercent, color: strengthColor } =
  ...
  return (
    <>
      <div className="min-h-screen flex items-center justify-center">
        <div
          className={`max-w-[394px] w-full rounded-lg ${shake ? "shake" : ""}`}
        >
          <div className="px-10 py-8 rounded-lg shadow-lg">
            {/* Header */}
            <h2 className="text-[25px] font-bold text-center text-blue-600 mb-8">
              ...
              {nextField ? (
                <Stack gap="md">
                  ...
                  <PasswordInput
                    ...
                    style={{
                      borderColor: checks.isPasswordValid
                        ? "#2ecc71"
                        : errorMessage
                          ? "#e50914"
                          : undefined,
          ...
          <div className="px-10 py-4 text-center rounded-lg shadow-lg">
            <p className="text-sm">
              ...
              <a
                href="/sign-in"
                className="text-blue-600 hover:border-b-2 border-blue-600 font-bold ml-1"
              >
                Sign in
              </a>
            </p>
